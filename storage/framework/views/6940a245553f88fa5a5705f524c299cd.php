                ...
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <?php elseif($deadline): ?>
                            ...
                            <small class="text-muted">
                                Sampai <?php echo e($deadline->format('d-m-Y H:i')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\php\warvote\resources\views/polls/dashboard.blade.php ENDPATH**/ ?>